...
const LowerSection = () => {
	return (
		<section id="contact" className="p-4 md:p-16 bg-white  ">
			<div className="bg-[#15191D] rounded-[30px] flex flex-col justify-center items-center gap-10 p-8 pt-16 pb-16">
                ...
                <p className="font-inter text-[#FFFFFF] text-sm text-center md:text-base opacity-60">Subscribe to our newsletter and stay up-to-date with all our programme and activities.</p>
